...
export default function Home() {
  return (
    <div className="bg-white">
          ...
          <div className="text-center max-w-5xl mx-auto">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                ...
                className="group bg-amber-500 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-amber-600 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
              >
              ...
              <Link
                ...
                className="bg-cyan-600 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-cyan-700 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
              >
                Join the Waitlist
              </Link>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="group bg-white p-8 rounded-2xl shadow-md hover:shadow-2xl transition-all duration-300 border border-slate-100 hover:border-cyan-200 hover:-translate-y-1">
              ...
              <p className="text-slate-600 leading-relaxed">
                Track your net worth across multiple currencies with real-time conversion. Perfect for NRIs and anyone with investments across India and abroad.
              </p>
            </div>
      ...
      <section className="relative py-16 bg-gradient-to-br from-cyan-600 to-cyan-700 overflow-hidden">
      ...
      <section className="py-16 bg-slate-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-3xl shadow-2xl p-10 md:p-12 text-center border border-slate-100">
